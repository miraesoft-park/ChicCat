...
contract SadCat is ERC721Enumerable, Ownable {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        uint256 sendAmount = cost.mul(_mintAmount);

        payable(ownerAddress).transfer(sendAmount);
